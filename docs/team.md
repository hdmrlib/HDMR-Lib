...
HDMR-Lib is maintained as an open-source software project. The codebase, issue tracking, and development history are available through the public repository.
