"""
Hyperspectral Data Analysis using EMPR Spectral Signatures
==========================================================
...
#
# .. image:: ../../_static/examples/indian_pines_gt.png
#    :align: center
#    :width: 40%

###############################################################################
# Implementation in HDMRLib
# -------------------------
...
# -----------------------
# The extracted component :math:`h_3` provides a decorrelated, summarized view of the spectral bands, serving as a clean baseline signature for the cropped region. 
#
# Key Benefits
# ^^^^^^^^^^^^
