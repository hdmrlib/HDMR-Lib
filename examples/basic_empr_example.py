...
# Attempt to run EMPR on all available backends, including CuPy if installed
backends_to_try = ['numpy', 'torch', 'tensorflow', 'cupy']
...
for backend in backends_to_try:
	try:
		...
		print('EMPR decomposition result shape:', tuple(result.shape))
